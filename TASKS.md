...
- [ ] B2 — FieldNavigatorVm (cây field + bulk move) + prop ủy quyền → đổi XAML → xóa ủy quyền
- [ ] B3 — FieldRulesEventsVm (+ sửa async void ExecuteDeleteEvent)
- [ ] B4 — FkLookupConfigVm (nhóm Fk* + template P4 + control-props; panel đổi DataContext, binding trong giữ nguyên; thay lambda += bằng handler đặt tên)
