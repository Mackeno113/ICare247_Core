...
2. **Reload do `ReloadTriggerField` quyết định** (ô *"Tự reload khi field thay đổi"*),
   **không** phải danh sách tag `reloadOnChange`.
   → Xem [LookupBoxRenderer.razor:141-156](../../src/frontend/ICare247.Blazor.RuntimeCheck/Components/FieldRenderers/LookupBoxRenderer.razor).
...
- Reload trigger runtime: [LookupBoxRenderer.razor](../../src/frontend/ICare247.Blazor.RuntimeCheck/Components/FieldRenderers/LookupBoxRenderer.razor) (dòng 137–176)
