...
Thực hiện (đọc `.claude-rules/database-design.md` — quy tắc đầy đủ; `docs/spec/02_DATABASE_SCHEMA.md` /
`docs/spec/11_DATA_DB_SCHEMA.md` — schema chi tiết; + memory verify-live-db-schema):
